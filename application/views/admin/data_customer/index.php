...
<div class="container-fluid p-0">
    <div class="row mb-3">
        <div class="col-lg-8 col-sm-8 col-12">
            <h1 class=" m-0 font-weight-light">Customer</h1>
            <span class="text-black-80"> <?=count($data)?> Customer</span>
        </div>
        <div class="col-lg-4 col-sm-4 col-12 mt-3 mt-lg-0 text-lg-right text-sm-right">
            <a href="<?php echo base_url('admin/customer/create/')?>" class="btn-icon-text btn btn-brand">
                <i data-feather="plus" class="align-middle"></i>
                <span class="ml-1 align-middle">Tambah Customer</span>
            </a>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-hover">
                            ...
                            <tr>
								...
								<td class="font-size-lg"><?php echo '+62 '.$value->no_telp ?></td>
                                ...
                                <td class="align-top text-center">
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            href="<?php echo base_url('admin/customer/update/'.$value->id_user)?>"
                                            >
                                                <span data-feather="edit" class="mr-1"></span><span>Edit customer</span>
                                        </a>
                                        ...
                                        data-link="<?php echo base_url('admin/customer/delete/'.$value->id_user)?>"
                                        >
