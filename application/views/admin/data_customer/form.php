...
<div class="container px-0 px-lg-3">
    <div class="mb-3">
		<a href="<?php echo base_url('admin/customer/')?>" class="btn btn-secondary btn-icon-text">
			<i data-feather="arrow-left" class="mr-1"></i>
			<span>Kembali</span>
		</a>
		<div class="float-right">
			<h4 class="m-0 text-black-60 font-weight-normal border-right pr-2" style="border-width:4px!important;"><?php if (isset($data)): ?>Edit<?php else: ?>Tambah<?php endif; ?> customer</h4>
		</div>
    </div>
	<div class="card">
		<div class="card-body">
		...
		<?php endif ?>
			...
			<div class="form-group row mt-lg-5 mt-4">
				<div class="col-sm-10 ml-sm-auto">
					...
					<a href="<?php echo base_url('admin/customer')?>" class="btn btn-danger">Batal </a>
				</div>
			</div>
			<?php echo form_close(); ?>
		</div>
