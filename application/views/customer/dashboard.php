...
?>
<!--== Header Hero ==-->
<?php $this->load->view('customer/dashboard_header'); ?>
<!--== Header Hero ==-->

<!--== About Us Area Start ==-->
<?php $this->load->view('customer/dashboard_about_feature'); ?>
<!--== About Us Area End ==-->

<!--== Services Area Start ==-->
<?php $this->load->view('customer/dashboard_barang'); ?>
<!--== Services Area End ==-->
<!--== Partner Area Start ==-->
<?php $this->load->view('customer/dashboard_partner'); ?>
<!--== Partner Area End ==-->
<!--== Fun Fact Area Start ==-->
<?php //$this->load->view('customer/dashboard_funfact'); ?>
<!--== Fun Fact Area End ==-->
