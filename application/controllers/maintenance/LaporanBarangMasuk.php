...
class LaporanBarangMasuk extends MY_Controller {
	...
	public function index()
	{
		...
		$config = getConfigPagination(base_url() . "maintenance/laporan/barangmasuk", count($this->maintenance->getAll(3, $date)), 5, 4);
		...
		$this->load->view('maintenance/laporan_barangmasuk/index', $data);
	}
